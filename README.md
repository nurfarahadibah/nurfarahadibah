...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=10,2,20&height=250&section=header&text=Hi,%20I'm%20Farah%20Adibah👋!&fontSize=40&desc=Aspiring%20Data%20Engineer&descSize=20&descAlignVertical=60&animation=fadeIn)
...
* 🤖 **[Real-Time Sentiment Analysis Pipeline: Apache Kafka & Spark](https://github.com/Jingyong14/HPDP02/tree/main/2425/project/p2/Group_7/Project-SentimentAnalysis/batch-realtime_processing)**
  * *Built a real-time ML-enabled data pipeline for Malaysian Reddit data using Apache Kafka and Apache Spark Streaming. Developed Naive Bayes and Logistic Regression models for sentiment classification, and integrated Elasticsearch and Kibana for real-time storage, monitoring, and visualization.*
